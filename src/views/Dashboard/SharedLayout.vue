<script setup>
import logoo from "@/assets/logoo-removebg-preview-transformed.png"
</script>
    ...
    <header
        ...
        <nav class="flex basis-full items-center w-full mx-auto px-4 sm:px-6" aria-label="Global">
            <div class="me-5 lg:me-0 lg:hidden">
                <!-- Logo -->
                <div class="flex items-center" aria-label="Kulmiye">
                    <img :src="logoo" class="w-auto h-10" alt="Logo">
                    <h1 class="font-bold text-blue-500"> Kulmiye </h1>
                </div>
                <!-- End Logo -->
            </div>
