...
const handleSubmit = async () => {
  loading.value = true;
  try {
    const { data, error: fetchError, statusCode } = await useFetch('https://kulmiye-api.up.railway.app/auth/token/login/')
      .post(formData.value)
      .json();
                ...
                <div>
                  ...
                  <div class="relative">
                    <input type="text" id="username" name="username"
                      ...
                      required aria-describedby="username-error" v-model="formData.username" />
