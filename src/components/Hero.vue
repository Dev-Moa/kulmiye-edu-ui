        ...
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
                ...
                <div class="text-center">
                    <p class="text-xs font-semibold text-gray-500 tracking-wide  mb-3">
                        Ardayda Rabta scholarship
                    </p>
                    <h1 class="text-3xl text-gray-800 font-bold sm:text-5xl lg:text-6xl lg:leading-tight">
                        Fur Fursadahaaga Mustaqbalka - <span class="text-blue-500"> Codso Deeq Waxbarasho! </span>
                    </h1>
                </div>
                <!-- End Title -->
                ...
                <div class="sm:flex sm:justify-center sm:items-center text-center sm:text-start">
                    <div class="flex-shrink-0 pb-5 sm:flex sm:pb-0 sm:pe-5">
                        ...
                        <div class="flex justify-center -space-x-3">
                            ...
                            <span
                                ...
                                <span class="text-xs font-medium leading-none text-white uppercase">20+</span>
                            </span>
                        </div>
                        <!-- End Avatar Group -->
                    </div>
                    ...
                    <div class="pt-5 sm:pt-0 sm:ps-5">
                        <div class="text-lg font-semibold text-gray-800">Jaamacadaha heli karto</div>
                        <div class="text-sm text-gray-500">In kabadan 20+ jaamacadood</div>
                    </div>
                </div>
                <!-- End Avatar Group -->
